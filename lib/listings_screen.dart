        ...
        child: ListView.separated(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            return GestureDetector(
              onTap: (){
                propertyNotifier.currentProperty = propertyNotifier.propertyList[index];
                      ...
                      Expanded(
                        ...
                        child: Padding(
                          ...
                          child: ClipRRect(
                            ...
                            child: Image.network(
                              propertyNotifier.propertyList[index].image != null
                                              ? propertyNotifier.propertyList[index].image.toString()
                                              : 'https://www.testingxperts.com/wp-content/uploads/2019/02/placeholder-img.jpg',
                              height: 100,
                              width: 140,
                            ),
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text(propertyNotifier.propertyList[index].adTitle.toString(),
                                  style:
                            ...
                            Padding(
                              padding: const EdgeInsets.all(2.0),
                              child: Text(
                                  propertyNotifier.propertyList[index].location.toString().toUpperCase(),
                            ...
                            Padding(
                              ...
                              child: Row(children: [
                                ...
                                Expanded(
                                  child: Text(propertyNotifier.propertyList[index].address.toString(),
                                      overflow: TextOverflow.ellipsis,
                                      style: const TextStyle(
                                          fontSize: 14,
                            ...
                            Wrap(children: [
                              ...
                              Text(
                                  "${propertyNotifier.propertyList[index].monthlyRent?.toInt()}/month",
